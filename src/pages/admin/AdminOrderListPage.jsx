...
const getOrderStatusLabel = (status) => {
  ...
  return ORDER_STATUS_META[normalized]?.label ?? status ?? '-';
};
    ...
    <main className="pt-16 min-h-screen bg-surface">
      <div className="p-lg max-w-[1280px] mx-auto w-full space-y-lg">
        <PageHeader
          ...
          subtitle="Theo dõi đơn hàng, trạng thái thanh toán và doanh thu từ khách hàng."
          actions={<button
            ...
            <div className="flex flex-wrap gap-2">
              {ORDER_STATUS_OPTIONS.map((item) => (
                <button
                  ...
                  className={`px-md py-2 rounded-lg text-label-sm transition-all ${statusFilter === item.value
